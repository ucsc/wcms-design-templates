...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="system-page">
        ...
        <!-- original method of displaying image, alt, and caption
        ...
        -->
        <!-- new abbreviated method to display image, image alternative text, and caption -->
        <xsl:if test="system-data-structure/banner/image/path != '/'">
            <div id="bannerBox" class="banners">
                <xsl:choose>
